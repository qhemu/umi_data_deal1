...
class JsonLogger:
    def __init__(self, path: str, 
        ...
        self.path = path  # '/home/xiuxiu/PycharmProjects/mobilealoha/universal_manipulation_interface/data/outputs/2024.05.12/18.11.32_train_diffusion_unet_timm_umi/logs.json.txt'
