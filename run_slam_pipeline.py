...
def main(session_dir, calibration_dir):
    # session_dir = "universal_manipulation_interface"
    script_dir = pathlib.Path(__file__).parent.joinpath('scripts_slam_pipeline')  # PosixPath('/home/xiuxiu/PycharmProjects/mobilealoha/universal_manipulation_interface/scripts_slam_pipeline')
    if calibration_dir is None:
        calibration_dir = pathlib.Path(__file__).parent.joinpath('example', 'calibration')  # PosixPath('/home/xiuxiu/PycharmProjects/mobilealoha/universal_manipulation_interface/example/calibration')
    else:
        calibration_dir = pathlib.Path(calibration_dir)
    assert calibration_dir.is_dir()
    for session in session_dir:
        session = pathlib.Path(os.path.expanduser(session)).absolute()  # PosixPath('/home/xiuxiu/PycharmProjects/mobilealoha/universal_manipulation_interface')

        print("############## 00_process_videos #############")
        script_path = script_dir.joinpath("00_process_videos.py")  # PosixPath('/home/xiuxiu/PycharmProjects/mobilealoha/universal_manipulation_interface/scripts_slam_pipeline/00_process_videos.py')
        ...
        '''
        cmd:['python', '/home/xiuxiu/PycharmProjects/mobilealoha/universal_manipulation_interface/scripts_slam_pipeline/00_process_videos.py',
        '/home/xiuxiu/PycharmProjects/mobilealoha/universal_manipulation_interface']
        '''
        print(cmd)
